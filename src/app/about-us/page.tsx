  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        <h2 className="text-xl font-semibold mb-4">রূপশী - আপনার বিশ্বস্ত অনলাইন শপিং প্লাটফর্ম</h2>

        <p className="mb-4">
          রূপশী একটি প্রিমিয়াম অনলাইন শপিং প্লাটফর্ম যা ২০২৪ সালে যাত্রা শুরু করে। আমরা বাংলাদেশের
          গ্রাহকদের জন্য উচ্চমানের পণ্য সহজ এবং নিরাপদ উপায়ে পৌঁছে দেওয়ার লক্ষ্য নিয়ে কাজ করছি।
        </p>

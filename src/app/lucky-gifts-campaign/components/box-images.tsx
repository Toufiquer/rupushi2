    ...
    <main className="w-full grid grid-cols-1 md:grid-cols-2 md:gap-3">
      <div className={boxStyle}>
        <div className="absolute top-0 left-0">
          <Image
            src="/3.png" // Replace with your actual logo path
      ...
      <div className={boxStyle}>
        <div className="absolute top-0 left-0">
          <Image
            src="/4.png" // Replace with your actual logo path
            alt="Rupush main products"
            width={1400}
            height={1400}
          />
      ...
      <div className={boxStyle}>
        <div className="absolute top-0 left-0">
          <Image
            src="/5.png" // Replace with your actual logo path
            alt="Rupush main products"
            width={1400}
            height={1400}
          />
      ...
      <div className={boxStyle}>
        <div className="absolute top-0 left-0">
          <Image
            src="/6.png" // Replace with your actual logo path
            alt="Rupush main products"
            width={1400}
            height={1400}
          />
